...
.Sell:
	call ExitMenu
	call BlackMarketSellMenu
	ld a, STANDARDMART_ANYTHINGELSE
	ret

.Quit:
	call ExitMenu
	ld hl, Text_BlackMarket_ComeAgain
	call MartTextbox
	ld a, STANDARDMART_EXIT
	ret
...
.AnythingElse:
	call LoadStandardMenuHeader
	ld hl, Text_BlackMarket_AskMore
	call PrintText
	ld a, STANDARDMART_TOPMENU
	ret
...
.MartTextFunctionPointers:
	...
	dwb .BlackMarketPointers, 0
	dwb .StandardMartPointers, 2
	dwb .BlackMarketPointers, 2
...
.BlackMarketPointers
	dw Text_BlackMarket_HowMany
	dw Text_BlackMarket_CostsThisMuch
	dw Text_BlackMarket_InsufficientFunds
	dw Text_BlackMarket_BagFull
	dw Text_BlackMarket_HereYouGo
	dw BuyMenuLoop
...
Text_BlackMarket_Intro:
	text_far BlackMarket_IntroText
	text_end

Text_BlackMarket_ComeAgain:
	text_far BlackMarket_ComeAgainText
	text_end

Text_BlackMarket_HowMany:
	text_far BlackMarket_HowManyText
	text_end

Text_BlackMarket_CostsThisMuch:
	text_far BlackMarket_CostsThisMuchText
	text_end

Text_BlackMarket_InsufficientFunds:
	text_far BlackMarket_InsufficientFundsText
	text_end

Text_BlackMarket_BagFull:
	text_far BlackMarket_BagFullText
	text_end

Text_BlackMarket_HereYouGo:
	text_far BlackMarket_HereYouGoText
	text_end

Text_BlackMarket_ThisIsReal:
	text_far BlackMarket_ThisIsRealText
	text_end

Text_BlackMarket_AskMore:
	text_far BlackMarket_AskMoreText
	text_end

Text_BlackMarket_BestICanDo:	
	text_far BlackMarket_BestICanDoText
	text_end
...
.okay_to_sell
	ld hl, Text_BlackMarket_ThisIsReal
	call PrintText
	farcall PlaceMoneyAtTopLeftOfTextbox
	farcall SelectQuantityToSell
	call ExitMenu
	...
	lb bc, 3, 18
	call ClearBox
	ld hl, Text_BlackMarket_BestICanDo
	call PrintTextboxText
	call YesNoBox
	jr c, .declined
	ld de, wMoney
	...
	lb bc, 3, 18
	call ClearBox
	ld hl, Text_BlackMarket_HereYouGo
	call PrintTextboxText
	call PlayTransactionSound
	farcall PlaceMoneyBottomLeft
	call JoyWaitAorB
