...
TilesetParkAnim:
	...
	dw vTiles2 tile $4A, AnimateWaterTile
	dw vTiles2 tile $17, AnimateFountain
	dw NULL,  WaitTileAnimation
	dw NULL,  AnimateWaterPalette
	dw NULL,  WaitTileAnimation
	dw NULL,  AnimateFlowerTile
...
TilesetMorganRoomAnim:
TilesetInterludeAnim:
TilesetCastorGymAnim:
TilesetForestDungeonAnim:
TilesetBeedrillDungeonAnim:
TilesetSpookyForestAnim:
TilesetBigBridgeAnim:
TilesetEtalonPortAnim:
TilesetBoatsAnim:
TilesetGoshaAnim:
TilesetTradHouseAnim:
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
	dw NULL,  WaitTileAnimation
