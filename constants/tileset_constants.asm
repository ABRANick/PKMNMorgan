; Tilesets indexes (see data/tilesets.asm)
	...
	const TILESET_MORGAN_ROOM		   ; 25
	const TILESET_ERABLE			   ; 26
	const TILESET_CASTOR			   ; 27
	const TILESET_INTERLUDE			   ; 29
	const TILESET_ROUTES_SNOW		   ; 30
	const TILESET_ROUTES		   	   ; 31
	const TILESET_CASTOR_GYM		   ; 32
	const TILESET_FOREST_DUNGEON
	const TILESET_BEEDRILL_DUNGEON
	const TILESET_SPOOKY_FOREST
	const TILESET_BIGBRIDGE
	const TILESET_ETALONPORT
	const TILESET_BOATS
	const TILESET_SAFARI
	const TILESET_OMEKATA
	const TILESET_GOSHA
	const TILESET_TRADHOUSE
