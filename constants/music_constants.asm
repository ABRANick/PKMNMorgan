...
; new to Crystal
	...
	const MUSIC_GYM_WIN
	const MUSIC_TRAINER_WIN					 ; 67
	const MUSIC_ROUTE_48
	const MUSIC_BLUEFIELD
	const MUSIC_ROUTE228
	const MUSIC_CIANWOODHGSS
	const MUSIC_GENGARPINBALL
	const MUSIC_RSPOKEMART
	const MUSIC_HUMILAUCITY 
	const MUSIC_FINALBATTLE
	const MUSIC_GYMLEADERBATTLE
	const MUSIC_VIRBANKCITY
	const MUSIC_MARTS
	const MUSIC_JAMZ_ENCOUNTER
	const MUSIC_JAMZ_BATTLE
	const MUSIC_BLACKMARKET
	const MUSIC_SAFARI
