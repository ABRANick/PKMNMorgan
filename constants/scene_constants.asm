...
;wErableTownSceneID
	const_def 
	const SCENE_RESCUE_GRANDMA 
	const SCENE_ERABLE_TOWN_NOTHING

;wMorganFirstFloorSceneID
	const_def 
	const SCENE_WITH_MORGAN_GRAMPS
	const SCENE_WITH_MORGAN_GRAMPS_PART2
	const SCENE_WITH_MORGAN_GRAMPS_NOTHING

;wInterludeErableID
	const_def
	const SCENE_ROUTE48_GATE
	const SCENE_ROUTE48_GATE_NOTHING

;wRoute47SceneID
	const_def 
	const SCENE_ROUTE47_MEET_LORELEI
	const SCENE_ROUTE47_NOTHING

;wIvysLabSceneID
	const_def 1
	const SCENE_IVYS_LAB_NOTHING
	const SCENE_IVYS_LAB_RIVAL_BATTLE

;wRoute48NSceneID
	const_def 
	const SCENE_ROUTE48N_RALTS_DANGER
	const SCENE_HELP_RALTS
	const SCENE_ROUTE48N_NOTHING
	const SCENE_MORGAN_FIRST_FIGHT

;wRoute48NCaveSceneID
	const_def
	const SCENE_NEED_WINTER_COAT
	const SCENE_ROUTE48N_CAVE_NOTHING

;CastorGymSceneID
	const_def
	const SCENE_GYMS_CLOSED
	const SCENE_GYMS_FREE

;wRoute49SceneID
	const_def
	const SCENE_ROUTE_49_GUARD
	const SCENE_ROUTE_49_BUG_CATCHER
	const SCENE_ROUTE_49_NOTHING

;wForestDungeonSceneID
	const_def
	const SCENE_CASTOR_WOODS_ANGERED
	const SCENE_CASTOR_WOODS_SAVED

;;wBeedrillDungeonSceneID
;	const_def
;	const SCENE_CLIMB_VINE

;wMouetteSceneID
	const_def
	const SCENE_TEST_MOUETTE
	const SCENE_FOLLOWUP_MOUETTE

;wGoshaGymSceneID
	const_def
	const SCENE_PAY_GUARD
	const SCENE_PAY_GUARD2
	const SCENE_PAY_GUARD3
	const SCENE_FIGHT_ERI
	const SCENE_BEAT_ERI
