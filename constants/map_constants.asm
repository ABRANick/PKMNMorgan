...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const MORGAN_HOUSE_2F,								5, 	4 ;  3		
	map_const MORGAN_HOUSE_1F,							    7,  5 ;  2
	map_const ERABLE_GENERIC_HOUSE_ONE, 					5,  4 
	map_const ERABLE_GENERIC_HOUSE_TWO, 					5,  4 
	map_const ERABLE_TOWN,                        		   15, 20 ;  1
	map_const INTERLUDE_ERABLE,								3,  5 ; 1						
	map_const ROUTE_48N,								   23, 30 ;  2
	map_const ROUTE_48N_CAVE,							   14, 15 
	map_const INTERLUDE_ROUTE48N,							3,  3 ; 3
	map_const ROUTE_47,									   17, 20								
	map_const SYROP,									   14, 20
	map_const SYROP_POKECENTER_1F,							5,  4 
	map_const IVYS_LAB,										9,  7
	map_const SYROP_MART,                                  6,  4 

	newgroup
	 
	map_const INTERLUDE_ROUTE48S,							3,  3 ; 4
	map_const ROUTE_48S,								   28, 29 ;  2
	map_const CASTOR,    								   32, 20 ;  1
	map_const CASTOR_POKECENTER_1F,					 		5,  4
	map_const CASTOR_BIKE_SHOP,                          	4,  4 ;  4
	map_const CASTOR_GYM,									7, 16					
	map_const CASTOR_TRAIN_STATION, 					   10,  9 ;
	map_const CASTOR_GENERIC_HOUSE_ONE,						5,  4 
	map_const CASTOR_GENERIC_HOUSE_TWO,						5,  4
	map_const CASTOR_MART,									6,  4 									
	map_const ROUTE_49, 								   30, 15 ;  3
	map_const FOREST_DUNGEON,							   28, 30 ;	 4	
	map_const BEEDRILL_DUNGEON, 						   15, 15

	newgroup

	map_const SPOOKY_FOREST, 						        8,  8 ; 1

	newgroup 

	map_const BRIDGE_NORTH,								   30, 30 ; 1
	map_const BRIDGE_EAST,								   15,  7 ; 2
	map_const BRIDGE_SOUTH,								   15, 25 ; 3
	map_const BRIDGE_SOUTH_WEST,						   15, 12 ; 4 	

	newgroup 

	map_const MOUETTE, 									   29, 25 ; 1
	map_const ROUTE_55, 								   15, 25 ; 3												
	map_const ROUTE_54, 								   27, 25 ; 2
	map_const MOUETTE_POKECENTER_1F,					   5,  4	
	map_const MOUETTE_LIGHTHOUSE_1F,					   10,  9
	map_const MOUETTE_LIGHTHOUSE_2F,					   10,  9						
	map_const MOUETTE_LIGHTHOUSE_3F,					   10,  9						
	map_const MOUETTE_LIGHTHOUSE_4F,					   10,  9
	map_const MOUETTE_LIGHTHOUSE_ROOF,					   10,  9
	map_const MOUETTE_MART,                                  6,  4 	

	newgroup

	map_const MOUETTE_GYM,								   15,  7
	map_const MOUETTE_MERCHANT,							   14,  7	
				
	newgroup

	map_const ROUTE_50,									   23, 13 ; 1
	map_const ROUTE_51, 								   11, 30 ; 2 
	map_const ROUTE_52,									   11, 30 ; 3
	map_const SAFARI,								   	   23, 22 ; 4
	map_const SAFARI_POKECENTER_1F,					 		5,  4
	map_const SAFARI_MART,                                  6,  4 
	map_const SAFARI_FISHING_GURU_HOUSE,					4,	4
	map_const SAFARI_GYM,									6,	9
	map_const SAFARI_GATE,									8,	4	
	map_const SAFARI_PLAINS,								21,	20
	
	newgroup 

	map_const OMEKATA,									   25, 15 ; 1
	map_const OMEKATA_TEMPLE,							   13, 14 ; 2
	map_const OMEKATA_ALLEY,							   16,  8 ; 3
	map_const OMEKATA_DOJO,								   11,	15
	map_const OMEKATA_POKECENTER_1F,					 		5,  4
	map_const OMEKATA_MART,                                  6,  4 
	map_const OMEKATA_TRAIN_STATION, 					   10,  9 ;
	map_const OMEKATA_BLACK_MARKET,							8,	5
	map_const OMEKATA_DOJO_INDOOR, 							8,	9
	

	newgroup
	
	map_const GOSHA,									   25, 17 ; 1
	map_const GOSHA_POKECENTER_1F,					 		5,  4
	map_const GOSHA_GYM,								   14, 23 ; 2	
	map_const GOSHA_MART,                                  6,  4 
	map_const GOSHA_TRAIN_STATION, 					   10,  9 ;
