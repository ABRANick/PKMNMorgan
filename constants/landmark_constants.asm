...
; Johto landmarks
	...
	const LANDMARK_ERABLE_TOWN
	const LANDMARK_ROUTE_47
	const LANDMARK_SYROP
	const LANDMARK_ROUTE_48N
	const LANDMARK_ROUTE_48S
	const LANDMARK_CASTOR 
	const LANDMARK_ROUTE_49
	const LANDMARK_TOURNESOL
	const LANDMARK_GRAVEYARD
	const LANDMARK_BIG_BRIDGE_NORTH
	const LANDMARK_BIG_BRIDGE_EAST		 
	const LANDMARK_BIG_BRIDGE_SOUTH		 
	const LANDMARK_BIG_BRIDGE_SOUTH_WEST
	const LANDMARK_MOUETTE
	const LANDMARK_ROUTE_55		 	 		 
	const LANDMARK_ROUTE_54
	const LANDMARK_BOATS
	const LANDMARK_ROUTE_50
	const LANDMARK_ROUTE_51
	const LANDMARK_ROUTE_52
	const LANDMARK_SAFARI
	const LANDMARK_OMEKATA
	const LANDMARK_OMEKATA_TEMPLE
	const LANDMARK_GOSHA
