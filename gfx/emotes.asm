...
DeathEmote:       INCBIN "gfx/emotes/death.2bpp"
...
MadEmote:       INCBIN "gfx/emotes/mad.2bpp"    
PissedEmote:    INCBIN "gfx/emotes/pissed.2bpp"     
PanicEmote:     INCBIN "gfx/emotes/panik.2bpp"
SweatEmote:     INCBIN "gfx/emotes/sweat.2bpp"    
