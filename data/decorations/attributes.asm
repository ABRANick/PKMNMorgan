...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  TAILOW,          SET_UP_POSTER,     EVENT_DECO_POSTER_4,                $25
	...
	decoration DECO_BIGDOLL, SNORLAX,         SET_UP_BIG_DOLL,   EVENT_DECO_BIG_SNORLAX_DOLL,        SPRITE_RALTS
	decoration DECO_BIGDOLL, ONIX,            SET_UP_BIG_DOLL,   EVENT_DECO_BIG_ONIX_DOLL,           SPRITE_RALTS
	decoration DECO_BIGDOLL, LAPRAS,          SET_UP_BIG_DOLL,   EVENT_DECO_BIG_LAPRAS_DOLL,         SPRITE_RALTS
	...
	; decoration DECO_DOLL,    TAILOW,      	  SET_UP_DOLL,       EVENT_DECO_JIGGLYPUFF_DOLL,         SPRITE_JIGGLYPUFF
	...
	; ; decoration DECO_DOLL,    SANDSHREW,       SET_UP_DOLL,       EVENT_DECO_DIGLETT_DOLL,            SPRITE_DIGLETT
	...
	; decoration DECO_DOLL,    ONIX,            SET_UP_DOLL,       EVENT_DECO_GRIMER_DOLL,             SPRITE_GRIMER
	;decoration DECO_DOLL,    SABLEYE,         SET_UP_DOLL,       EVENT_DECO_VOLTORB_DOLL,            SPRITE_VOLTORB
	...
	; decoration DECO_DOLL,    STARYU,          SET_UP_DOLL,       EVENT_DECO_TENTACOOL_DOLL,          SPRITE_TENTACOOL
