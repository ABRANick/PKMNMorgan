...
MapScenes::
	...
	scene_var ERABLE_TOWN,								   wErableTownSceneID
	scene_var MORGAN_HOUSE_1F,							   wMorganFirstFloorSceneID
	scene_var INTERLUDE_ERABLE,							   wInterludeErableID					
	scene_var ROUTE_48N,								   wRoute48NSceneID	
	scene_var ROUTE_48N_CAVE, 							   wRoute48NCaveSceneID	
	scene_var CASTOR_GYM,								   wCastorGymSceneID
	scene_var ROUTE_49,									   wRoute49SceneID	
	scene_var FOREST_DUNGEON,							   wForestDungeonSceneID
	scene_var MOUETTE,									   wMouetteSceneID
	scene_var GOSHA_GYM,								   wGoshaGymSceneID
