...
ENDM
	...
	map_attributes Route48S, ROUTE_48S, $05, SOUTH
	connection south, Castor, CASTOR, -4

	map_attributes Castor, CASTOR, $05, NORTH | SOUTH
	connection north, Route48S, ROUTE_48S, 4
	connection south, Route49, ROUTE_49, -15

	map_attributes Route49, ROUTE_49, $05, NORTH
	connection north, Castor, CASTOR, 15

	map_attributes Route23, ROUTE_23, $0f, 0
	map_attributes MorganHouse2F, MORGAN_HOUSE_2F, $00, 0
	map_attributes MorganHouse1F, MORGAN_HOUSE_1F, $00, 0
	map_attributes ErableGenericHouseOne, ERABLE_GENERIC_HOUSE_ONE, $00, 0
	map_attributes ErableGenericHouseTwo, ERABLE_GENERIC_HOUSE_TWO, $00, 0

	map_attributes ErableTown, ERABLE_TOWN, $00, EAST
	connection east, Route47, ROUTE_47, 0
	map_attributes Syrop, SYROP, $0, WEST
	connection west, Route47, ROUTE_47, 0

	map_attributes Route47, ROUTE_47, $00, WEST | EAST
	connection west, ErableTown, ERABLE_TOWN, 0
	connection east, Syrop, SYROP, 0

	map_attributes BridgeNorth, BRIDGE_NORTH, $00, SOUTH | EAST
	connection south, BridgeSouth, BRIDGE_SOUTH, 5
	connection east, BridgeEast, BRIDGE_EAST, 18

	map_attributes BridgeEast, BRIDGE_EAST, $00, WEST
	connection west, BridgeNorth, BRIDGE_NORTH, -18

	map_attributes BridgeSouth, BRIDGE_SOUTH, $00, NORTH | WEST
	connection north, BridgeNorth, BRIDGE_NORTH, -5
	connection west, BridgeSouthWest, BRIDGE_SOUTH_WEST, 17

	map_attributes BridgeSouthWest, BRIDGE_SOUTH_WEST, $00, EAST
	connection east, BridgeSouth, BRIDGE_SOUTH, -17

	map_attributes Mouette, MOUETTE, $00, WEST 
	connection west, Route55, ROUTE_55, 0

	map_attributes Route55, ROUTE_55, $00, WEST | EAST
	connection west, Route54, ROUTE_54, 0
	connection east, Mouette, MOUETTE, 0

	map_attributes Route54, ROUTE_54, $00, EAST
	connection east, Route54, ROUTE_54, 0

	map_attributes Route50, ROUTE_50, $00, WEST
	connection west, Route51, ROUTE_51, -13

	map_attributes Route51, ROUTE_51, $00, SOUTH | EAST
	connection south, Route52, ROUTE_52, 0
	connection east, Route50, ROUTE_50, 13

	map_attributes Route52, ROUTE_52, $00, NORTH | SOUTH
	connection north, Route51, ROUTE_51, 0
	connection south, Safari, SAFARI, -5

	map_attributes Safari, SAFARI, $00, NORTH
	connection north, Route52, ROUTE_52, 5

	map_attributes Omekata, OMEKATA, $00, NORTH | WEST| EAST
	connection north, OmekataTemple, OMEKATA_TEMPLE, 5
	connection west, OmekataDojo, OMEKATA_DOJO, 0
	connection east, OmekataAlley, OMEKATA_ALLEY, 1

	map_attributes OmekataTemple, OMEKATA_TEMPLE, $0C, SOUTH
	connection south, Omekata, OMEKATA, -5

	map_attributes OmekataDojo, OMEKATA_DOJO, $0C, EAST
	connection east, Omekata, OMEKATA, 0

	map_attributes OmekataAlley, OMEKATA_ALLEY, $0C, WEST
	connection west, Omekata, OMEKATA, -1


	map_attributes Gosha, GOSHA, $00, 0
	map_attributes GoshaPokecenter1F, GOSHA_POKECENTER_1F, $00, 0
	map_attributes GoshaGym, GOSHA_GYM, $00, 0
	map_attributes GoshaMart, GOSHA_MART, $00, 0
	map_attributes GoshaTrainStation, GOSHA_TRAIN_STATION, $00, 0
	map_attributes OmekataPokecenter1F, OMEKATA_POKECENTER_1F, $00, 0
	map_attributes OmekataMart, OMEKATA_MART, $00, 0
	map_attributes OmekataTrainStation, OMEKATA_TRAIN_STATION, $00, 0
	map_attributes OmekataBlackMarket, OMEKATA_BLACK_MARKET, $00, 0
	map_attributes OmekataDojoIndoor, OMEKATA_DOJO_INDOOR, $00, 0
	map_attributes MouettePokecenter1F, MOUETTE_POKECENTER_1F, $00, 0
	map_attributes MouetteMart, MOUETTE_MART, $00, 0
	map_attributes SafariPokecenter1F, SAFARI_POKECENTER_1F, $00, 0
	map_attributes SafariMart, SAFARI_MART, $00, 0
	map_attributes SafariFishingGuruHouse, SAFARI_FISHING_GURU_HOUSE, $00, 0
	map_attributes SafariGym, SAFARI_GYM, $00, 0
	map_attributes SafariGate, SAFARI_GATE, $00, 0
	map_attributes SafariPlains, SAFARI_PLAINS, $00, 0
	map_attributes InterludeErable, INTERLUDE_ERABLE, $00, 0					
	map_attributes Route48N, ROUTE_48N, $00, 0
	map_attributes Route48N_Cave, ROUTE_48N_CAVE, $00, 0
	map_attributes InterludeRoute48N, INTERLUDE_ROUTE48N, $00, 0					   
	map_attributes InterludeRoute48S, INTERLUDE_ROUTE48S, $00, 0
	map_attributes SyropPokecenter1F, SYROP_POKECENTER_1F, $00, 0
	map_attributes SyropMart, SYROP_MART, $00, 0
	map_attributes IvysLab, IVYS_LAB, $00, 0
	map_attributes CastorPokecenter1F, CASTOR_POKECENTER_1F, $00, 0
	map_attributes CastorBikeShop, CASTOR_BIKE_SHOP, $00, 0
	map_attributes CastorGym, CASTOR_GYM, $00, 0
	map_attributes CastorTrainStation, CASTOR_TRAIN_STATION, $00, 0
	map_attributes CastorGenericHouseOne, CASTOR_GENERIC_HOUSE_ONE, $00, 0
	map_attributes CastorGenericHouseTwo, CASTOR_GENERIC_HOUSE_TWO, $00, 0
	map_attributes CastorMart, CASTOR_MART, $00, 0
	map_attributes ForestDungeon, FOREST_DUNGEON, $00, 0
	map_attributes BeedrillDungeon, BEEDRILL_DUNGEON, $00, 0
	map_attributes SpookyForest, SPOOKY_FOREST, $00, 0
	map_attributes MouetteLightHouse1F, MOUETTE_LIGHTHOUSE_1F, $00, 0
	map_attributes MouetteLightHouse2F, MOUETTE_LIGHTHOUSE_2F, $00, 0
	map_attributes MouetteLightHouse3F, MOUETTE_LIGHTHOUSE_3F, $00, 0
	map_attributes MouetteLightHouse4F, MOUETTE_LIGHTHOUSE_4F, $00, 0
	map_attributes MouetteLightHouseRoof, MOUETTE_LIGHTHOUSE_ROOF, $00, 0
	map_attributes MouetteGym, MOUETTE_GYM, $00, 0
	map_attributes MouetteMerchant, MOUETTE_MERCHANT, $00, 0
