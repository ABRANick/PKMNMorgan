...
; pointers to the first map of each map group
	...
	dw MapGroup_Erable		; 27
	dw MapGroup_Castor		; 28
	dw MapGroup_SpookyForest ; 29
	dw MapGroup_BigBridge ; 30
	dw MapGroup_EtalonPort
	dw MapGroup_Boats
	dw MapGroup_Safari
	dw MapGroup_Omekata
	dw MapGroup_Gosha
...
MapGroup_Erable:
	map MorganHouse2F, TILESET_MORGAN_ROOM, INDOOR, LANDMARK_ERABLE_TOWN, MUSIC_CIANWOODHGSS, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map MorganHouse1F, TILESET_MORGAN_ROOM, INDOOR, LANDMARK_ERABLE_TOWN, MUSIC_CIANWOODHGSS, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ErableGenericHouseOne, TILESET_MORGAN_ROOM, INDOOR, LANDMARK_ERABLE_TOWN, MUSIC_CIANWOODHGSS, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ErableGenericHouseTwo, TILESET_MORGAN_ROOM, INDOOR, LANDMARK_ERABLE_TOWN, MUSIC_CIANWOODHGSS, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map ErableTown, TILESET_ERABLE, TOWN, LANDMARK_ERABLE_TOWN, MUSIC_CIANWOODHGSS, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map InterludeErable, TILESET_INTERLUDE, ROUTE, LANDMARK_ERABLE_TOWN, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route48N, TILESET_ERABLE, ROUTE, LANDMARK_ROUTE_48N, MUSIC_ROUTE_48, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route48N_Cave, TILESET_CAVE, CAVE, LANDMARK_ROUTE_48N, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map InterludeRoute48N, TILESET_INTERLUDE, ROUTE, LANDMARK_ROUTE_48N, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route47, TILESET_ERABLE, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_48, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Syrop, TILESET_ERABLE, TOWN, LANDMARK_SYROP, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SyropPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SYROP, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map IvysLab, TILESET_LAB, INDOOR, LANDMARK_SYROP, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SyropMart, TILESET_MART, INDOOR, LANDMARK_SYROP, MUSIC_MARTS, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Castor:
	map InterludeRoute48S, TILESET_INTERLUDE, ROUTE, LANDMARK_ROUTE_48S, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route48S, TILESET_CASTOR, ROUTE, LANDMARK_ROUTE_48S, MUSIC_ROUTE228, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Castor, TILESET_CASTOR, TOWN, LANDMARK_CASTOR, MUSIC_BLUEFIELD, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CastorPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CASTOR, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CastorBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CASTOR, MUSIC_BLUEFIELD, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CastorGym, TILESET_CASTOR_GYM, INDOOR, LANDMARK_CASTOR, MUSIC_GYM, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CastorTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_CASTOR, MUSIC_BLUEFIELD, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CastorGenericHouseOne, TILESET_MORGAN_ROOM, INDOOR, LANDMARK_CASTOR, MUSIC_BLUEFIELD, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CastorGenericHouseTwo, TILESET_MORGAN_ROOM, INDOOR, LANDMARK_CASTOR, MUSIC_BLUEFIELD, FALSE, PALETTE_DAY, FISHGROUP_NONE 
	map CastorMart, TILESET_MART, INDOOR, LANDMARK_CASTOR, MUSIC_RSPOKEMART, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Route49, TILESET_CASTOR, ROUTE, LANDMARK_ROUTE_49, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestDungeon, TILESET_FOREST_DUNGEON, CAVE, LANDMARK_TOURNESOL, MUSIC_CASTOR_WOODS, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map BeedrillDungeon, TILESET_BEEDRILL_DUNGEON, CAVE, LANDMARK_TOURNESOL, MUSIC_CASTOR_WOODS, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	
MapGroup_SpookyForest:
	map SpookyForest, TILESET_SPOOKY_FOREST, CAVE, LANDMARK_GRAVEYARD, MUSIC_GENGARPINBALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE

MapGroup_BigBridge:
	map BridgeNorth, TILESET_BIGBRIDGE, ROUTE, LANDMARK_BIG_BRIDGE_NORTH, MUSIC_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map BridgeEast, TILESET_BIGBRIDGE, ROUTE, LANDMARK_BIG_BRIDGE_EAST, MUSIC_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map BridgeSouth, TILESET_BIGBRIDGE, ROUTE, LANDMARK_BIG_BRIDGE_SOUTH, MUSIC_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map BridgeSouthWest, TILESET_BIGBRIDGE, ROUTE, LANDMARK_BIG_BRIDGE_SOUTH_WEST, MUSIC_BICYCLE, FALSE, PALETTE_AUTO, FISHGROUP_NONE

MapGroup_EtalonPort:
	map Mouette, TILESET_ETALONPORT, TOWN, LANDMARK_MOUETTE, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route55, TILESET_ETALONPORT, ROUTE, LANDMARK_ROUTE_55, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route54, TILESET_ETALONPORT, ROUTE, LANDMARK_ROUTE_54, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouettePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_MOUETTE, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map MouetteLightHouse1F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouetteLightHouse2F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouetteLightHouse3F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouetteLightHouse4F, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouetteLightHouseRoof, TILESET_LIGHTHOUSE, DUNGEON, LANDMARK_LIGHTHOUSE, MUSIC_LIGHTHOUSE, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouetteMart, TILESET_MART, INDOOR, LANDMARK_MOUETTE, MUSIC_MARTS, FALSE, PALETTE_DAY, FISHGROUP_SHORE


MapGroup_Boats: 
	map MouetteGym, TILESET_BOATS, INDOOR, LANDMARK_BOATS, MUSIC_GYM, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MouetteMerchant, TILESET_BOATS, INDOOR, LANDMARK_BOATS, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE


MapGroup_Safari:
	map Route50, TILESET_SAFARI, ROUTE, LANDMARK_ROUTE_50, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route51, TILESET_SAFARI, ROUTE, LANDMARK_ROUTE_51, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route52, TILESET_SAFARI, ROUTE, LANDMARK_ROUTE_52, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Safari, TILESET_SAFARI, TOWN, LANDMARK_SAFARI, MUSIC_SAFARI, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SafariPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SAFARI, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariMart, TILESET_MART, INDOOR, LANDMARK_SAFARI, MUSIC_MARTS, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SafariFishingGuruHouse, TILESET_HOUSE, INDOOR, LANDMARK_SAFARI, MUSIC_SAFARI, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SafariGym, TILESET_CASTOR_GYM, INDOOR, LANDMARK_SAFARI, MUSIC_GYM, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SafariGate, TILESET_GATE, INDOOR, LANDMARK_SAFARI, MUSIC_SAFARI, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map SafariPlains, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_POND

MapGroup_Omekata:
	map Omekata, TILESET_OMEKATA, TOWN, LANDMARK_OMEKATA, MUSIC_HUMILAUCITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map OmekataTemple, TILESET_OMEKATA, TOWN, LANDMARK_OMEKATA_TEMPLE, MUSIC_DANCING_HALL, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map OmekataAlley, TILESET_OMEKATA, TOWN, LANDMARK_OMEKATA, MUSIC_HUMILAUCITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map OmekataDojo, TILESET_OMEKATA, TOWN, LANDMARK_OMEKATA, MUSIC_HUMILAUCITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map OmekataPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_OMEKATA, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OmekataMart, TILESET_MART, INDOOR, LANDMARK_OMEKATA, MUSIC_MARTS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OmekataTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_OMEKATA, MUSIC_HUMILAUCITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OmekataBlackMarket, TILESET_TRADHOUSE, INDOOR, LANDMARK_OMEKATA, MUSIC_BLACKMARKET, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OmekataDojoIndoor, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_OMEKATA, MUSIC_DRAGONS_DEN, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Gosha:
	map Gosha, TILESET_GOSHA, TOWN, LANDMARK_GOSHA, MUSIC_VIRBANKCITY, TRUE, PALETTE_AUTO, FISHGROUP_NONE	
	map GoshaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_GOSHA, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoshaGym, TILESET_GAME_CORNER, INDOOR, LANDMARK_GOSHA, MUSIC_GAME_CORNER, TRUE, PALETTE_AUTO, FISHGROUP_NONE 
	map GoshaMart, TILESET_MART, INDOOR, LANDMARK_GOSHA, MUSIC_MARTS, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoshaTrainStation, TILESET_TRAIN_STATION, INDOOR, LANDMARK_GOSHA, MUSIC_VIRBANKCITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
