...
; entries correspond to SPRITE_ANIM_OAMSET_* constants
	...
	dbw $00, .OAMData_MagnetTrainBrown         ; SPRITE_ANIM_OAMSET_MAGNET_TRAIN_RED_1
	dbw $04, .OAMData_MagnetTrainBrown         ; SPRITE_ANIM_OAMSET_MAGNET_TRAIN_RED_2
	...
	dbw $00, .OAMData_GreenWalk                 ; SPRITE_ANIM_OAMSET_BLUE_WALK_1
	dbw $04, .OAMData_GreenWalk                 ; SPRITE_ANIM_OAMSET_BLUE_WALK_2
	dbw $00, .OAMData_MagnetTrainGreen          ; SPRITE_ANIM_OAMSET_MAGNET_TRAIN_BLUE_1
	dbw $04, .OAMData_MagnetTrainGreen          ; SPRITE_ANIM_OAMSET_MAGNET_TRAIN_BLUE_2
...
.OAMData_MagnetTrainBrown:
	db 4
	dsprite -1,  0, -1,  0, $00, PAL_OW_BROWN | PRIORITY
	dsprite -1,  0,  0,  0, $01, PAL_OW_BROWN | PRIORITY
	dsprite  0,  0, -1,  0, $02, PAL_OW_BROWN | PRIORITY
	dsprite  0,  0,  0,  0, $03, PAL_OW_BROWN | PRIORITY