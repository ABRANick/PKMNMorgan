...
.Frameset_MagnetTrainBrown:
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_BROWN_1,  8
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_BROWN_2,  8
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_BROWN_1,  8
	frame SPRITE_ANIM_OAMSET_MAGNET_TRAIN_BROWN_2,  8, OAM_X_FLIP
	dorestart
...
.Frameset_BrownWalk:
	...
	frame SPRITE_ANIM_OAMSET_BROWN_WALK_1,  8
	frame SPRITE_ANIM_OAMSET_BROWN_WALK_2,  8, OAM_X_FLIP
	dorestart
