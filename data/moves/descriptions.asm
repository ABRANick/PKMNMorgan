MoveDescriptions::
; entries correspond to move ids (see constants/move_constants.asm)Description
	...
	dw MoveAADescription
	dw MoveBBDescription
	dw MoveCCDescription
	dw MoveFDDescription
	dw MoveEEDescription
   	dw MoveGGDescription
	dw MoveHHDescription
	dw MoveJJDescription     
