...
; entries correspond to ENGINE_* constants
	...
	engine_flag wStatusFlags2, STATUSFLAGS2_MARCHESI_IN_CASTOR_WOODS_F
	...
	engine_flag wVisitedSpawns, SPAWN_ERABLE
	...
	engine_flag wDailyFlags1, DAILYFLAGS1_GOT_HOUNDOUR_F
