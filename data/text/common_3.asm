...
_BallBrokeFreeText::
	text "Oh phooey! It was"
	line "not even close!"
	prompt

_BallAppearedCaughtText::
	text "Ah, nuts! Thought"
	line "I had it!"
	prompt

_BallAlmostHadItText::
	text "Oh my Gosh! Just"
	line "stay in the ball!"
	prompt
...
BlackMarket_IntroText::
	text "Oh look..."
	
	para "It's HIS brat."
	done

BlackMarket_ComeAgainText::
	text "Don't come back"
	line "without more"
	cont "money."
	done

BlackMarket_HowManyText::
	text "And you want how"
	line "many?"
	done

BlackMarket_CostsThisMuchText::
	text_ram wStringBuffer2
	text " is"
	line "¥@"
	text_decimal hMoneyTemp, 3, 6
...
BlackMarket_InsufficientFundsText::
	text "Hey..."

	para "What kind of crap"
	line "are you trying to"
	cont "pull!?"
	done

BlackMarket_BagFullText::
	text "You're carrying"
	line "too much junk."
	done

BlackMarket_HereYouGoText::
	text "Here."
	done

BlackMarket_ThisIsRealText::
	text "This is real,"
	line "yes?"
	done

BlackMarket_AskMoreText::
	text "You still got"
	line "business here?"
	done

BlackMarket_BestICanDoText::
	text "Any less and I'd"
	line "be selling at a"
