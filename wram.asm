...
wErableTownSceneID::							  db
wMorganFirstFloorSceneID::						  db
wInterludeErableID::						  	  db
wRoute48NSceneID::								  db
wRoute48NCaveSceneID::							  db
wCastorGymSceneID::								  db	
wRoute49SceneID:: 								  db
wForestDungeonSceneID::							  db
;wBeedrillDungeonSceneID::						  db
wMouetteSceneID::								  db
wGoshaGymSceneID::							      db 
